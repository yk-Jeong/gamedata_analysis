...
데이터를 기반으로 다음 분기에 어떤 게임을 출시·설계해야 할지 결정해야 한다면? <br><br>
이와 같은 상황을 가정하고, **1980년대부터 2010년대까지의 게임 데이터**를 분석하며 다음의 세 가지 질문에 대답하고자 함 


    1. 지역에 따라서 선호하는 게임 장르가 다를까?

    2. 연도별로 게임의 트렌드가 존재할까?

    3. 출고량이 높은 게임의 특징을 분석하고, 이를 시각화한다면?
